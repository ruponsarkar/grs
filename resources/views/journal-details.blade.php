                ...
                <div class="row" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="col-lg-9 mt-4 mt-lg-0">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane border border-warning rounded text-center p-3 shadow-lg bg-body" id="tab-3">
                                <div class="row">
                                        ...
                                        <div class="card">
                                            <div class="editorial pt-3">
                                             ...
                                             <div class="card-body text-center editorial-style">
                                                ...
                                                <div class="card-text pb-2" style="font-size: small"><strong> {{$data->university}}</strong></div>
                                                <div class="card-text fst-italic pb-2" style="font-size: small; text-align: justify" > {{$data->details}} </div>
                                ...
                                <div class="row border border-warning rounded p-3 shadow-lg bg-body">
                                    <div class="col-lg-12 details order-2 order-lg-1">
                                        ...
                                        <div class="gallery">
                                            ...
                                            <a target="_blank" class="btn btn-outline-success" href="{{$index->link}}">
                                                <img src="{{url('assets/img/indexing/'.$index->img)}}"
