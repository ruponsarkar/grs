...
class IndexController extends Controller
{
    ...
    function search(Request $request)
    {
        ...
        $results = manuscript_status::where('muuid', 'LIKE', "%{$query}%")->orderByDesc('id')->first(); // Adjust the field 'name' based on your model
   ...
   function manuscript(){
    ...
    function OpenAccessPolicy(){
        $data = DB::table('pages')->where('type', 'OpenAccessPolicy')->orderBy('id', 'desc')->first();
        return view('OpenAccessPolicy',  ['data'=>$data]);
    }
    function ProcessingFee(){
        $data = DB::table('pages')->where('type', 'ProcessingFee')->orderBy('id', 'desc')->first();
        return view('ProcessingFee',  ['data'=>$data]);
    }
    function PrivacyPolicy(){
        $data = DB::table('pages')->where('type', 'PrivacyPolicy')->orderBy('id', 'desc')->first();
